...
// Fish SVG (base layer)
const fish_svg = `<svg viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000" transform="matrix(-1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
...
// Arrow SVG (overlay layer)
const arrow_svg = `<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
  <path fill="rgba(0,0,0,0.8)" stroke="white" stroke-width="1" d="m24 40-2.1-2.15L34.25 25.5H8v-3h26.25L21.9 10.15 24 8l16 16Z"/>
</svg>`;

// Default layered stimuli - fish with arrow overlay
export const layered_stimuli = [
  fish_svg,
  arrow_svg
];

// Fish only
export const fish_only = [
  fish_svg
];

// Arrow only  
export const arrow_only = [
  arrow_svg
];
