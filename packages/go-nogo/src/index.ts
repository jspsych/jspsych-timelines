...
export function createTimeline(
  ...
  const goNoGoTrial = createGoNoGo(jsPsych, text_object.buttonText, trial_timeout)
  const isi_timeoutTrial = createISIFixation(isi_timeout, text_object.buttonText)
