...
const animalStimuli: Array<listSortingWorkingMemoryTestStimulusInfo> = [
  { stimulus_image: "dog.jpg", stimulus_audio: "dog.mp3" },
  { stimulus_image: "bird.jpg", stimulus_audio: "bird.mp3" },
  { stimulus_image: "elephant.jpg", stimulus_audio: "elephant.mp3" },
  { stimulus_image: "lion.jpg", stimulus_audio: "lion.mp3" },
  { stimulus_image: "monkey.jpg", stimulus_audio: "monkey.mp3" },
  { stimulus_image: "rabbit.jpg", stimulus_audio: "rabbit.mp3" },
  { stimulus_image: "mouse.jpg", stimulus_audio: "mouse.mp3" },
  { stimulus_image: "whale.jpg", stimulus_audio: "whale.mp3" },
];

const foodStimuli: Array<listSortingWorkingMemoryTestStimulusInfo> = [
  { stimulus_image: "apple.jpg", stimulus_audio: "apple.mp3" },
  { stimulus_image: "grape.jpg", stimulus_audio: "grape.mp3" },
  { stimulus_image: "pizza.jpg", stimulus_audio: "pizza.mp3" },
  { stimulus_image: "pumpkin.jpg", stimulus_audio: "pumpkin.mp3" },
  { stimulus_image: "turkey.jpg", stimulus_audio: "turkey.mp3" },
  { stimulus_image: "bean.jpg", stimulus_audio: "bean.mp3" },
  { stimulus_image: "mushroom.jpg", stimulus_audio: "mushroom.mp3" },
  { stimulus_image: "shrimp.jpg", stimulus_audio: "shrimp.mp3" },
];
