...
| Antisaccade | `antisaccade` | Attention | 🟢 | 🟢 | ⬜ | ⬜ |
...
| 2026-01-14 | Antisaccade Task: Created `@jspsych-timelines/antisaccade` package. Mobile-friendly button-based antisaccade/prosaccade paradigm for inhibitory control. Features: Gap timing between fixation and cue, prosaccade (same side) and antisaccade (opposite side) blocks, RT cost calculation, error tracking, practice with feedback, full text parameterization. 38 passing tests. |
